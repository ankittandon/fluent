...
- Bundles the offline summary model from `models/summary/gemma-3-1b-it-q4_k_m.gguf`
- Runs bundled summaries locally with Gemma 3 through a dedicated `llama.cpp` helper, using Metal offload on Apple Silicon when available
